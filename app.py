...
def seed_all_skus():
    ...
    hub_assignments = {
        ...
        "Hub 2": [
            ...
            "Witchy Vibes", "White and Green Stripes", "Black Solid", "Black and White Stripes", "Black and Orange",
        ],
        "Hub 3": [
...
def restore_table_from_csv(table_name):
    ...
    if uploaded_file is not None:
        try:
            ...
            allowed_columns = [col[1] for col in query(f"PRAGMA table_info({table_name})")]
